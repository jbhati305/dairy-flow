...
export const animals: Animal[] = [
  {
    ...
    healthHistory: [
      { date: "2026-06-01", note: "Routine checkup, normal vitals", vet: "Dr. Anjali Kulkarni" },
      { date: "2026-03-14", note: "Minor foot infection treated", vet: "Dr. Anjali Kulkarni" },
    ],
    vaccinationHistory: [
  ...
  },
  {
    ...
    healthHistory: [{ date: "2026-05-20", note: "Routine checkup, normal vitals", vet: "Dr. Anjali Kulkarni" }],
  ...
  },
  {
    ...
    healthHistory: [{ date: "2026-06-10", note: "Routine checkup, normal vitals", vet: "Dr. Sameer Deshpande" }],
  ...
  },
  {
    ...
    healthHistory: [
      { date: "2026-07-10", note: "Mild lethargy observed, under monitoring", vet: "Dr. Anjali Kulkarni" },
    ],
  ...
  },
  {
    ...
    healthHistory: [{ date: "2026-04-02", note: "Routine checkup, normal vitals", vet: "Dr. Sameer Deshpande" }],
  ...
  },
  {
    ...
    healthHistory: [
      { date: "2026-07-15", note: "Yield dropped 18% over 5 days, feed intake reduced", vet: "Dr. Anjali Kulkarni" },
    ],
  ...
  },
  {
    ...
    healthHistory: [{ date: "2026-05-01", note: "Pregnancy confirmed via ultrasound", vet: "Dr. Sameer Deshpande" }],
  ...
  },
  {
    ...
    healthHistory: [{ date: "2026-06-25", note: "Dry-off checkup, healthy", vet: "Dr. Anjali Kulkarni" }],
  ...
  },
  {
    ...
    healthHistory: [
      { date: "2026-07-18", note: "Signs of mastitis detected in rear left quarter", vet: "Dr. Anjali Kulkarni" },
    ],
  ...
  },
  {
    ...
    healthHistory: [{ date: "2026-06-01", note: "Routine checkup, normal vitals", vet: "Dr. Sameer Deshpande" }],
...
// Generate additional animals to reach a realistic herd size of 128 total (28 detailed + 100 summarized)
const breeds: Animal["breed"][] = ["Gir", "Sahiwal", "Holstein Friesian", "Jersey", "Murrah Buffalo"];
const statuses: Animal["lactationStatus"][] = ["Lactating", "Lactating", "Lactating", "Dry", "Pregnant", "Calf"];
const health: Animal["healthStatus"][] = ["Healthy", "Healthy", "Healthy", "Healthy", "Under Observation", "Treatment Required"];
const names = [
...
function seedAnimal(i: number): Animal {
  ...
  const lactationStatus = statuses[i % statuses.length];
  const healthStatus = health[i % health.length];
  ...
  const currentMilkYield = isLactating ? Math.max(6, baseYield + yieldVariance * 0.4) : 0;
  const id = `DF-${112 + i}`;
  return {
    id,
    ...
    nextCheckup: "2026-0" + (7 + (i % 2)) + "-2" + (i % 8),
    ...
    recentYield: isLactating
      ...
      : [],
    notes: "No additional notes on file.",
  };
}

export const allAnimals: Animal[] = [...animals, ...Array.from({ length: 117 }, (_, i) => seedAnimal(i))];
